...
class Categories:
    ...
    def _fill_aliases(self, categories: List[Dict]) -> List[Category]:
        ...
        for index, category in enumerate(categories):
            ...
            aliases = [a.encode('WINDOWS-1251').decode('utf-8') for a in aliases]
            aliases.append(category["codename"].encode('WINDOWS-1251').decode('utf-8'))
            aliases.append(category["name"].encode('WINDOWS-1251').decode('utf-8'))
            categories_result.append(Category(
                codename=category['codename'].encode('WINDOWS-1251').decode('utf-8'),
                name=category['name'].encode('WINDOWS-1251').decode('utf-8'),
